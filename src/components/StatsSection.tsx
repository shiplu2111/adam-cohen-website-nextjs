...
const socialStats = [
  {
    ...
    value: "34K+",
    label: "FOLLOWERS",
    link: "https://www.linkedin.com/in/adamcohentoday/",
    icon: (
  ...
  },
  {
    ...
    value: "Growing",
    label: "CHANNEL",
    link: "https://www.youtube.com/@adamscohentoday",
    icon: (
  ...
  },
  {
    ...
    value: "3,048,949",
    label: "FOLLOWERS",
    link: "https://www.instagram.com/adamcohentoday",
    icon: (
  ...
  },
  {
    ...
    value: "6,372,341",
    label: "FOLLOWERS",
    link: "https://www.facebook.com/adamcohentodayinc",
    icon: (
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 md:gap-8 lg:gap-6">
          {displayStats.map((stat, i) => {
            const originalStat = socialStats.find(os => os.platform.toLowerCase() === stat.platform.toLowerCase());
            const icon = originalStat?.icon || socialStats[0].icon;
            const link = originalStat?.link || "#";
            ...
            return (
              ...
              >
                <a 
                  ...
                  className="flex flex-col items-center justify-center w-full p-8 md:p-10 bg-white border border-gray-100 rounded-3xl transition-all duration-500 hover:shadow-2xl hover:border-transparent hover:-translate-y-2 overflow-hidden"
                >
