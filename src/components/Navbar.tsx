...
const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Inquiry Form", href: "/business-concierge/inquiry" },
    ],
  },
  {
    label: "Broadcast Media",
    submenu: [
      { label: "Business Brainstorm", href: "/business-brainstorm" },
      { label: "COHENTV – The Podcast", href: "/podcasts" },
      { label: "Live Events – Book Adam", href: "/live-events" },
      { label: "Interview Requests", href: "/podcast/interview-request" },
    ],
  },
